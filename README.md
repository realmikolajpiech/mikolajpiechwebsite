...
`SEO-CONTENT-PROPOSAL.md` records the approved homepage headlines and introductions, which are applied in English and Polish. Proposed titles, meta descriptions, dedicated project pages, and related-site credits still await owner confirmation.
