...
function buildAllProjects(language: Language): Project[] {
  ...
  },
  {
    ...
    studioLink: 'https://clevrapps.com/apps/trailo/',
  ...
  },
  {
    ...
    studioLink: 'https://clevrapps.com/twojasiec',
    icon: twojaSiecLogo,
    image: twojaSiecFeed,
    layout: 'split',
    screenshots: [
  ...
  },
  {
    ...
    studioLink: 'https://clevrapps.com/apps/subby/',
  ...
  },
  {
    ...
    role: tr('Founder · Product design & engineering', 'Założyciel · Projekt i rozwój produktu'),
    scope: tr('Full product · design to launch', 'Kompleksowa realizacja · od projektu po wdrożenie'),
    studioLink: 'https://clevrapps.com/apps/doso/',
  ...
  },
  {
    ...
    studioLink: 'https://clevrapps.com/apps/solvee/',
    icon: solveeLogo,
    image: solvee1,
    layout: 'split',
    screenshots: [
